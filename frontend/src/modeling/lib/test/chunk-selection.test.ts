...
describe("Chunk selection rendering", () => {
  ...
  it("should handle setting and clearing selection frames", () => {
    const selectionData = {
      ...
      frame: {
        ...
        voxelData: new SparseVoxelOctree({ x: 4, y: 4, z: 4 }),
      },
      offset: { x: 0, y: 0, z: 0 },
    };

    // Set a few voxels in the selection
    selectionData.frame.voxelData.setByIndex(0, 1); // x=0, y=0, z=0
    selectionData.frame.voxelData.setByIndex(1, 1); // x=0, y=0, z=1
  ...
  it("should handle multiple selection frames from different users", () => {
    ...
    selectionData1.frame.voxelData.setByIndex(0, 1);
    ...
    selectionData2.frame.voxelData.setByIndex(5, 1);
