...
export namespace PaintBlock {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: PaintBlock): void {
    PaintBlock.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): PaintBlock {
    return PaintBlock.getTypeScriptAlgebraicType().deserialize(reader);
  }
