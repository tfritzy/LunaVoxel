...
let _cached_Vector3_type_value: __AlgebraicTypeType | null = null;
...
export const Vector3 = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_Vector3_type_value) return _cached_Vector3_type_value;
    _cached_Vector3_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_Vector3_type_value.value.elements.push(
    ...
    return _cached_Vector3_type_value;
  },
