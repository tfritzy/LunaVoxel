...
export namespace BuildBlock {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: BuildBlock): void {
    BuildBlock.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): BuildBlock {
    return BuildBlock.getTypeScriptAlgebraicType().deserialize(reader);
  }
