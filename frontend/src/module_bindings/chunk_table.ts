 ...
 */
export class ChunkTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<Chunk>;

  constructor(tableCache: __TableCache<Chunk>) {
