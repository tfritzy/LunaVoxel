...
const REMOTE_MODULE = {
  tables: {
    atlas: {
      ...
      primaryKeyInfo: {
        colName: "projectId",
        colType: Atlas.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    color_palette: {
      ...
      primaryKeyInfo: {
        colName: "projectId",
        colType: ColorPalette.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    layer: {
      tableName: "layer",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Layer.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    layer_history_entry: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: LayerHistoryEntry.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    player_cursor: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: PlayerCursor.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    project_blocks: {
      ...
      primaryKeyInfo: {
        colName: "projectId",
        colType: ProjectBlocks.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    projects: {
      tableName: "projects",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Project.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    user: {
      tableName: "user",
    ...
    user_projects: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: UserProject.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
  },
  reducers: {
