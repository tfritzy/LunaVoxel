...
export const ToggleLayerLock = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: ToggleLayerLock): void {
    __AlgebraicTypeValue.serializeValue(writer, ToggleLayerLock.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): ToggleLayerLock {
    return __AlgebraicTypeValue.deserializeValue(reader, ToggleLayerLock.getTypeScriptAlgebraicType());
  },

}

export default ToggleLayerLock;
