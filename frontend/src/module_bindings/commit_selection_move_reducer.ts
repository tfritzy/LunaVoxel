 ...
 */
export const CommitSelectionMove = {
  /**
  * A function which returns this type represented as an AlgebraicType.
  * This function is derived from the AlgebraicType used to generate this type.
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_CommitSelectionMove_type_value) return _cached_CommitSelectionMove_type_value;
  ...
  serialize(writer: __BinaryWriter, value: CommitSelectionMove): void {
    __AlgebraicTypeValue.serializeValue(writer, CommitSelectionMove.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): CommitSelectionMove {
    return __AlgebraicTypeValue.deserializeValue(reader, CommitSelectionMove.getTypeScriptAlgebraicType());
  },

}

export default CommitSelectionMove;
