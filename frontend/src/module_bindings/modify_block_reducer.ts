 ...
 */
export const ModifyBlock = {
  /**
  * A function which returns this type represented as an AlgebraicType.
  * This function is derived from the AlgebraicType used to generate this type.
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_ModifyBlock_type_value) return _cached_ModifyBlock_type_value;
  ...
  serialize(writer: __BinaryWriter, value: ModifyBlock): void {
    __AlgebraicTypeValue.serializeValue(writer, ModifyBlock.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): ModifyBlock {
    return __AlgebraicTypeValue.deserializeValue(reader, ModifyBlock.getTypeScriptAlgebraicType());
  },
