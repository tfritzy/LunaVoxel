          ...
          {currentUser?.isAnonymous ? (
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-secondary/10 transition-colors"
              >
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-card border border-border rounded-md shadow-lg py-1 z-50">
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2 text-left text-sm hover:bg-secondary/10 transition-colors flex items-center gap-2"
                  >
