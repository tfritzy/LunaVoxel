...
interface AxisArrowMultiPickerProps {
  label: string;
  enabledDirections: Set<string>;
  onToggle: (direction: ShapeDirection) => void;
}
...
export const AxisArrowMultiPicker = ({
  label,
  enabledDirections,
  onToggle,
}: AxisArrowMultiPickerProps) => {
  return (
    <div>
      ...
      <svg width="150" height="150" viewBox="0 0 150 150">
        ...
        {DIRECTIONS.map(({ dir, screenAngleDeg, axis, label: dirLabel }) => {
          ...
          const isEnabled = enabledDirections.has(dir);
          const color = isEnabled ? AXIS_COLORS[axis] : DISABLED_COLOR;
          ...
          return (
            <g
              ...
              role="button"
              aria-label={`Toggle ${dir} direction`}
